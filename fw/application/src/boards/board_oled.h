...
#define BACK_BUTTON_PULL NRF_GPIO_PIN_PULLUP
#define BACK_BUTTON_ACTIVE_STATE 0
#define BACK_BUTTON_CANDIDATE_PINS_COUNT 14
#define BACK_BUTTON_CANDIDATE_PINS { 4, 8, 11, 12, 13, 14, 15, 16, 17, 20, 21, 22, 23, 24 }
